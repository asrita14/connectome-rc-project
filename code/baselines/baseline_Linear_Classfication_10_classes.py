...
# === Output Directory ===
OUTPUT_DIR = "figs_baseline_linear_10cls"
...
report_csv_path = os.path.join(OUTPUT_DIR, "classification_report_linear_10cls.csv")
report_df.to_csv(report_csv_path)
print(f"Classification report saved to {report_csv_path}")

# Save predictions
predictions_df = pd.DataFrame({"y_true": y_test, "y_pred": y_pred})
predictions_path = os.path.join(OUTPUT_DIR, "predictions_linear_10cls.csv")
...
plt.title("Confusion Matrix - Linear Classifier (Ridge, 10 Classes)")
plt.tight_layout()
cm_plot_path = os.path.join(OUTPUT_DIR, "confusion_matrix_linear_10cls.png")

...
print("\n===== Evaluation Summary (SVM Classifier) =====")
...
# === Save Results ===
results_summary = {
    "model": "SVM Classifier (RBF Kernel)",
    "accuracy": accuracy,
    "macro_f1": macro_f1,
    "micro_f1": micro_f1,
...
metrics_path = os.path.join(OUTPUT_DIR, "evaluation_metrics_svm.txt")
with open(metrics_path, "w") as f:
    f.write("===== Evaluation Summary (SVM Classifier) =====\n")
...
predictions_path = os.path.join(OUTPUT_DIR, "predictions_svm.csv")
...
plt.title("Confusion Matrix - SVM Classifier (RBF)")
plt.tight_layout()
cm_plot_path = os.path.join(OUTPUT_DIR, "confusion_matrix_svm.png")
plt.savefig(cm_plot_path)
print(f"Confusion matrix plot saved to {cm_plot_path}")
# plt.show() # Optionally display the plot

print("\nBaseline SVM script finished.")
